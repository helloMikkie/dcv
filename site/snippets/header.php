...
<nav class="submenu-site">
    ...
    <ul class="links-site">
        ...
        <li><a href="#">EN</a></li>
        <li class="toggle toggle-close"><a href="#"></a></li>
    </ul>
</nav>
...
<main>
    ...
    <header>
        <nav class="header-content">
            ...
            <a href="<?= url('/') ?>">
                <img src="assets/images/logo_dcv.svg" alt="logo" class="header-logo">
            </a>
            <ul class="toggle-links">
                <li class="toggle toggle-search"><a href="#"></a></li>
                <li class="toggle toggle-shop"><a href="#" ></a></li>
                <li class="toggle toggle-site"><a href="#"></a></li>
